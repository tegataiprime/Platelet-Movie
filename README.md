...
- ❤️ **Favourites feature**: Mark movies you want to watch with a heart icon (persisted in browser's local storage), toggle to show only your favourites
...
- **Favourites Feature**: 
  - Mark movies you want to watch by clicking the heart icon (🤍 → ❤️)
  ...
  - Heart icons are styled with American Red Cross Red (#E42424) when selected
